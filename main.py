...
async def main():
    ...
    dp.include_router(lughatlarim_router)     # My vocabularies
    dp.include_router(mashqlar_router)        # Exercises
    dp.include_router(ommaviylar_router)      # Public vocabularies
    dp.include_router(essential_router)       # Essential vocabularies
    dp.include_router(parallel_router)        # Parallel translations
