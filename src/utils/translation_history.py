...
def save_translation_history(
    ...
    """
    try:
        # Table mavjudligini tekshirish va yaratish
        sql.execute("""
        ...
        sql.execute("""
            ...
            (user_id, from_lang, to_lang, original_text, translated_text)
            VALUES (%s, %s, %s, %s, %s)
...
def get_translation_history(
    ...
    Returns:
        List of (id, from_lang, to_lang, original_text, translated_text, created_at)
    """
    try:
        sql.execute("""
            SELECT id, from_lang, to_lang, original_text, translated_text, created_at
...
def get_favorite_translations(user_id: int) -> List[Tuple[int, str, str, str, str]]:
    ...
    Returns:
        List of (id, from_lang, to_lang, original_text, translated_text)
    """
    try:
        sql.execute("""
            SELECT id, from_lang, to_lang, original_text, translated_text
            FROM translation_history
