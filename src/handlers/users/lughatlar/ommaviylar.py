...
def public_book_detail_kb(book_id: int, is_own: bool, lang: str) -> InlineKeyboardMarkup:
    ...
    buttons.append([InlineKeyboardButton(text="🔙 Orqaga", callback_data="ommaviy:back_to_cabinet")])
...
def create_mixed_books_kb(books: list, current_page: int, total_pages: int, lang: str) -> InlineKeyboardMarkup:
    ...
    rows.append([InlineKeyboardButton(text=L["back"], callback_data="ommaviy:back_to_cabinet")])
...
def start_public_practice_kb(lang: str) -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text=L["back"], callback_data="ommaviy:back_to_cabinet")]
    ])
...
async def send_next_public_question(msg: Message, state: FSMContext, lang: str):
    ...
    kb = InlineKeyboardMarkup(inline_keyboard=[
                                                  ...
                                                  [InlineKeyboardButton(text=L["main_menu"], callback_data="ommaviy:back_to_cabinet")]
                                              ])
