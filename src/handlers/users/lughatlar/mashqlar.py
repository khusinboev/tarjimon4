...
def create_practice_books_kb(books: list, current_page: int, total_pages: int, lang: str) -> InlineKeyboardMarkup:
    ...
    rows.append([InlineKeyboardButton(text=L["back"], callback_data="mashq:back_to_cabinet")])
...
def start_practice_kb(lang: str) -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text=L["back"], callback_data="mashq:back_to_cabinet")]
    ])
    ...
    kb = InlineKeyboardMarkup(
        inline_keyboard=[
                        ...
                        [
                            ...
                            [InlineKeyboardButton(text=L["main_menu"], callback_data="mashq:back_to_cabinet")]
                        ])
...
async def cb_practice_finish(cb: CallbackQuery, state: FSMContext):
    ...
    if GAMIFICATION_ENABLED and total_answers > 0:
        try:
            ...
            logging.error(f"Gamification error in practice: {e}")
