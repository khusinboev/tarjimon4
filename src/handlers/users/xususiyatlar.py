...
def update_user_lang(user_id: int, lang_code: str, direction: str):
    ...
    if sql.fetchone():
        ...
        sql.execute("INSERT INTO user_languages (user_id, from_lang, to_lang) VALUES (%s, %s, %s)", (user_id, from_lang, to_lang))
    db.commit()

# --- TILLAR INLINE MENYUSI ---
...
def get_language_inline_keyboard(user_id: int):
    ...
    # Auto til yuqorida ajratib ko‘rsatiladi
    buttons.append([
